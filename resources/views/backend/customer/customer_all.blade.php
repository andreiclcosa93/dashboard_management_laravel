            ...
            <div class="col-12">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active text-info">Customer</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tr>
                                ...
                                <th class="d-flex justify-content-center">
                                    <a href="{{ route('customer.add') }}" class="btn btn-success btn-rounded waves-effect waves-light" style="float:right;">Add Customer </a>
                                </th>
                            </tr>
                            </thead>
                            ...
                            <tbody>
                                @foreach($customers as $key => $item)
                                    <tr>
                                        <td> {{ $key+1}} </td>
                                        <td> {{ $item->name }} </td>
                                        <td> <img src="{{ asset($item->customer_image) }}" alt="" style="width: 60px; height: 60px"> </td>
