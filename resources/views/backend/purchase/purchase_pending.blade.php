            ...
            <div class="col-12">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active text-info">Purchase Pending</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="mt-3" style="margin-right: 30px">
                        <a href="{{ route('purchase.add') }}" class="btn btn-success btn-rounded waves-effect waves-light" style="float:right;">Add Product </a>
                    </div>
                    <div class="card-body">
