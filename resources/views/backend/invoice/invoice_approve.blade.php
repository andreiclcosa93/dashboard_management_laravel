            ...
            <div class="col-12">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('invoice.pending.list') }}">Invoice Pending</a></li>
                        <li class="breadcrumb-item active text-info">Invoice Approve</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="mt-3" style="margin-right: 30px">
                        <div class="text-center">
                            <h4 class="text-info">Invoice No: #{{ $invoice->invoice_no }} - {{ date('d-m-Y',strtotime($invoice->date)) }}</h4>
                        </div>
                        <a href="{{ route('invoice.pending.list') }}" class="btn btn-warning btn-rounded waves-effect waves-light mb-5" style="float:right;"><i class="fas fa-list"></i> Pending Invoice List </a>
                    </div>
                    <div class="card-body">
