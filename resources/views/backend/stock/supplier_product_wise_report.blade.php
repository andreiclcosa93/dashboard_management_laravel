                                    ...
                                    <form method="GET" action="{{ route('supplier.wise.pdf') }}" id="myForm"  >
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 form-group">
                                                ...
                                                <select name="supplier_id" class="form-select select2"  style="width: 200px;">
                                            ...
                                            <div class="col-sm-4" >
                                                <button type="submit" class="btn btn-primary" target="_blank">Search</button>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="md-3">
                                                    ...
                                                    <select name="category_id" id="category_id" class="form-select select2" aria-label="Default select example" style="width: 200px;">
                                            ...
                                            <div class="col-md-4">
                                                <div class="md-3">
                                                    ...
                                                    <select name="product_id" id="product_id" class="form-select select2" aria-label="Default select example" style="width: 200px;">
                                                        <option selected="">Open this select menu</option>
                                                    </select>
                                                </div>
                                            </div>
